...
class GroupIntegrationDetailsEndpoint(GroupEndpoint):
    ...
    def get(
        ...
        # serialize()'s generic param is bound at IntegrationSerializer, so the helper
        # infers the base response shape, not the IntegrationIssueConfigResponse emitted here.
        issue_config = cast(
            IntegrationIssueConfigResponse,
            serialize(
                integration,
